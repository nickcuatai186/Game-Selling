<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ThemSanPham_NPT.aspx.cs" Inherits="DoanWeb.Admin.ThemSanPham_NPT" %>
    ...
    <table style="width:100%;">
        <tr>
            <td class="auto-style1">
                <p class="auto-style8">
                    <strong>Thêm Nhà Phát Triển Sản Phẩm</strong></p>
                <p>
                    <table style="width:100%;">
                        <tr>
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btnquaylai" runat="server" PostBackUrl="~/Admin/SanPham_NPT.aspx" Text="Quay lại" BackColor="#009933" BorderStyle="Outset" CssClass="auto-style9" ForeColor="White" />
            </td>
        </tr>
    </table>
</asp:Content>
